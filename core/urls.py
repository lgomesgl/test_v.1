...
from .views import IndexTemplateView, TabelasTemplateView, CreateUserCreateView, AboutTemplateView, ProjetosCreateView, EmpresasCreateView, PessoasCreateView, ProjetosUpTemplateView, EmpreasasUpTemplateView, PessoasUpTemplateView
