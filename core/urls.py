...
from .views import IndexTemplateView, TabelasTemplateView,CreateUserCreateView, ProjetosCreateView, EmpresasCreateView, PessoasCreateView, ProjetosUpTemplateView, EmpreasasUpTemplateView, PessoasUpTemplateView
